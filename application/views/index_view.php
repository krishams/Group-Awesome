...
<div id="logon">
    ...
    <form class="loginForm" action="index.php/main_controller/getHome" method="POST">
        <table>
            ...
            <tr><td><?php echo anchor('main_controller/getRegistration', 'Not signed up?'); ?></td>
            </tr>
            <tr><td><?php echo anchor('main_controller/getRequestPassword', 'Forgot your password?'); ?></td>
            </tr>
        </table>
